...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AnsjLibraryAccessors laccForAnsjLibraryAccessors = new AnsjLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>ansj</b>
     */
    public AnsjLibraryAccessors getAnsj() {
        return laccForAnsjLibraryAccessors;
    }
    ...
    public static class AnsjLibraryAccessors extends SubDependencyFactory {

        public AnsjLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>seg</b> with <b>org.ansj:ansj_seg</b> coordinates and
         * with version reference <b>ansj.seg</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSeg() {
            return create("ansj.seg");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final AnsjVersionAccessors vaccForAnsjVersionAccessors = new AnsjVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.ansj</b>
         */
        public AnsjVersionAccessors getAnsj() {
            return vaccForAnsjVersionAccessors;
        }

    }

    public static class AnsjVersionAccessors extends VersionFactory  {

        public AnsjVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>ansj.seg</b> with value <b>5.1.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSeg() { return getVersion("ansj.seg"); }
